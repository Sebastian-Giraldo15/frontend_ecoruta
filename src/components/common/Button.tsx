...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-eco-600 text-white hover:bg-eco-700 focus:ring-eco-500 shadow-sm hover:shadow-eco',
    secondary: 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-eco-500 shadow-sm',
