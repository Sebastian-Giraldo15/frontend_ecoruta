...
export const empresaService = {
  async create(empresaData: EmpresaCreateRequest): Promise<APIResponse<Empresa>> {
  ...
  async update(id: number, empresaData: Partial<EmpresaCreateRequest>): Promise<APIResponse<Empresa>> {
